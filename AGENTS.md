...
You can add your mistakes here to prevent them from happen in the future.

- Reusable functions must receive output destinations as parameters and must not hard-code project output paths internally.
...
## Annotations
Please add annotations to functions to explain what is does and the parameters  